...
public class DataProviderCsv implements DataProvider {
    private final static Logger log = LogManager.getLogger(DataProviderCsv.class);
    private final String PATH = ConfigurationUtil.getConfigurationEntry("path_csv_file");
    private final String FILE_EXTENTION = ConfigurationUtil.getConfigurationEntry("csv_file_extention");
    ...
    @Override
    public List<Object> createOutfit(long idOutfit, Date dateStartWork, long idCustomer, long idHeadOfDepartment, long idPlaceWork, String typeWork,
                                String typeInstrument, long idTypeMeasurementInstrument, List<Long> idEmployees, StatusWork statusWork) throws NoSuchElementException {
        Outfit outfit;
        try {
            ...
            List<Employee> listEmployeeFromCsv = getRecordsFromCsvFile(Employee.class);
            ...
            List<Outfit> listOutfitFromCsv = getRecordsFromCsvFile(Outfit.class);
            ...
            List<HeadOfDepartment> listHeadOfDepartment = getRecordsFromCsvFile(HeadOfDepartment.class);
            ...
            setRecordsToCsvFile(listOutfitFromCsv);
    ...
    public boolean deleteOutfit(long idOutfit, long idHeadOfDepartment) {
        ...
        try {
            checkFileExists(Outfit.class);
            List<Outfit> listOutfitFromCsv = getRecordsFromCsvFile(Outfit.class);
            if ((boolean) findExistsHeadOfDepartmentId(idHeadOfDepartment).get(0) || findExistsOutfitId(idOutfit) || checkOutfitsNotNull(listOutfitFromCsv)) {
                return false;
            }
            newListOutfit = listOutfitFromCsv.stream()
            ...
            setRecordsToCsvFile(newListOutfit);
    ...
    public List<Object> editOutfit(long idOutfit, List<Long> idEmployees, long idHeadOfDepartment) {
        ...
        try {
            ...
            List<Employee> listEmployeeFromCsv = getRecordsFromCsvFile(Employee.class);
            List getEmployeesOutfit = findExistsEmployeeId(idEmployees);
            if ((boolean) findExistsHeadOfDepartmentId(idHeadOfDepartment).get(0) || findExistsOutfitId(idOutfit) || (boolean) getEmployeesOutfit.get(0) || checkIdEmployeesNotNull(idEmployees) || checkOutfitsNotNull(listOutfitFromCsv) || checkCountEmployees(idEmployees) || checkAllEmployeesId(listEmployeeFromCsv, idEmployees)) {
                return Arrays.asList(false, null);
            }
            Outfit changeOutfit = listOutfitFromCsv.stream()
    ...
    public List<Object> allEmployeeOutfits(long idAnalysis, long idHeadOfDepartment) {
        ...
        try {
            List<Outfit> listOutfitFromCsv = getRecordsFromCsvFile(Outfit.class);
            if ((boolean) findExistsHeadOfDepartmentId(idHeadOfDepartment).get(0) || (boolean)findExistsEmployeeId(Arrays.asList(idAnalysis)).get(0) || checkOutfitsNotNull(listOutfitFromCsv)) {
                return Arrays.asList(false, null);
            }
            listEmployeeIdOutfits = listOutfitFromCsv.stream()
    ...
    public List<Object> allExecutorOutfits(long idAnalysis, long idHeadOfDepartment) {
        ...
        try {
            List<Outfit> listOutfitFromCsv = getRecordsFromCsvFile(Outfit.class);
            if ((boolean) findExistsHeadOfDepartmentId(idHeadOfDepartment).get(0) || findExistsExecutorId(idAnalysis) || checkOutfitsNotNull(listOutfitFromCsv)) {
                return Arrays.asList(false, null);
            }
            listExecutorInOutfits = listOutfitFromCsv.stream()
    ...
    public List<Object> addEmployee(long idEmployee, String name, long idHeadOfDepartment) {
        ...
        try {
            ...
            List<Employee> listEmployeeFromCsv = getRecordsFromCsvFile(Employee.class);
            if (!(boolean) checkForDuplicatesEmployeeId(Arrays.asList(idEmployee), listEmployeeFromCsv).get(0)) {
            ...
            listEmployeeFromCsv.add(employee);
            setRecordsToCsvFile(listEmployeeFromCsv);
    ...
    public List<Object> promoteEmployee(long idEmployee, long idHeadOfDepartment) {
        ...
        try {
            List<Employee> listEmployeeFromCsv = getRecordsFromCsvFile(Employee.class);
            if ((boolean) findExistsHeadOfDepartmentId(idHeadOfDepartment).get(0) || (boolean) findExistsEmployeeId(Arrays.asList(idEmployee)).get(0) || checkEmployeesNotNull(listEmployeeFromCsv)) {
                return Arrays.asList(false, null);
            }
            changeEmployee = listEmployeeFromCsv.stream()
            ...
            newListEmployee = listEmployeeFromCsv.stream()
            ...
            setRecordsToCsvFile(newListEmployee);
    ...
    public List<Object> finishWork(long idOutfit, long idExecutor) {
        ...
        try {
            List<Outfit> listOutfitFromCsv = getRecordsFromCsvFile(Outfit.class);
            if (findExistsOutfitId(idOutfit) || findExistsExecutorId(idExecutor) || checkOutfitsNotNull(listOutfitFromCsv)) {
                return Arrays.asList(false, null);
            }
            changeOutfit = listOutfitFromCsv.stream()
                    .filter(e -> e.getId() == idOutfit).findFirst().get();
    ...
    private boolean findExistsExecutorId(long idExecutor) throws IOException {
        List<Executor> executors = getRecordsFromCsvFile(Executor.class);
    ...
    private List<Object> findExistsHeadOfDepartmentId(long idHeadOfDepartment) throws IOException {
        List<HeadOfDepartment> listHeadOfDepartment = getRecordsFromCsvFile(HeadOfDepartment.class);
    ...
    private boolean findExistsOutfitId(long idOutfit) throws IOException {
        List<Outfit> listOutfit = getRecordsFromCsvFile(Outfit.class);
    ...
    private List<Object> findPlaceWorkId(long idPlaceWork) throws IOException {
        List<PlaceOfWork> listPlaceWork = getRecordsFromCsvFile(PlaceOfWork.class);
    ...
    private List<Object> findExistsCustomerId(long idCustomer) throws IOException {
        List<Customer> listCustomer = getRecordsFromCsvFile(Customer.class);
    ...
    private List<Object> findExistsEmployeeId(List<Long> idEmployee) throws IOException {
        List<Employee> listEmployee = getRecordsFromCsvFile(Employee.class);
    ...
    private List<Object> checkIdTypeMeasurementInstrument(TypeMeasurementInstrument typeInstrument, long id) {
        try {
            ...
            if (typeInstrument == TypeMeasurementInstrument.ELECTRICAL) {
                List<ElectricalMeasurement> listElectricalMeasurementFromCsv = getRecordsFromCsvFile(ElectricalMeasurement.class);
                dublicateId = listElectricalMeasurementFromCsv.stream()
                        .filter(e -> e.getId() == id)
                        .collect(Collectors.toList());
                boolean flag = dublicateId.isEmpty();
                ...
                List<MechanicalMeasurement> listMechanicalMeasurementFromCsv = getRecordsFromCsvFile(MechanicalMeasurement.class);
                dublicateId = listMechanicalMeasurementFromCsv.stream()
                        .filter(e -> e.getId() == id)
                        .collect(Collectors.toList());
                boolean flag = dublicateId.isEmpty();
                meansOfMeasurement =(MeansOfMeasurement) dublicateId.get(0);
    ...
    public Status initDataSource() {
        try {
            ...
            setRecordsToCsvFile(listCustomer);
            setRecordsToCsvFile(listExecutor);
            setRecordsToCsvFile(listEmployee);
            setRecordsToCsvFile(listPlaceOfWorks);
            setRecordsToCsvFile(listMechanicalMeasurement);
            setRecordsToCsvFile(listElectricalMeasurement);
            setRecordsToCsvFile(listHeadOfDepartment);
            setRecordsToCsvFile(listOutfit);
    ...
    private Outfit createNewOutfit(long id, long idCustomer, long idExecutor, long idPlaceWork, List<Long> idEmployees, StatusWork statusWork, Date dateStartWork, long idTypeMeasurementInstrument, TypeOfWork typeOfWork) throws IOException {
        Outfit outfit = new Outfit();
        outfit.setId(id);
        List<Customer> customers = getRecordsFromCsvFile(Customer.class);
        ...
        outfit.setExecutor(executor);
        List<Employee> employees = getRecordsFromCsvFile(Employee.class);
        List<Employee> employeesOufit = getEmployeesOutfit(idEmployees, employees);
        outfit.setEmployees(employeesOufit);
        outfit.setStatusWork(statusWork);
        outfit.setDateStartWork(dateStartWork);
        List<MeansOfMeasurement> meansOfMeasurements = getRecordsFromCsvFile(MechanicalMeasurement.class);
        meansOfMeasurements.addAll(getRecordsFromCsvFile(ElectricalMeasurement.class));
        ...
        outfit.setTypeWork(typeOfWork);
        List<PlaceOfWork> places = getRecordsFromCsvFile(PlaceOfWork.class);
    ...
    public <T> void setRecordsToCsvFile(List<T> list) throws IOException {
        FileWriter filePath;
        CSVWriter writer = null;
        try {
            filePath = new FileWriter(PATH + list.get(0).getClass().getSimpleName().toLowerCase() + FILE_EXTENTION, false);
    ...
    public <T> List<T> getRecordsFromCsvFile(Class chooseClass) throws NoSuchElementException, IOException {
        FileReader fileReader;
        CSVReader csvReader = null;
        List<T> list = null;
        try {
            list = new ArrayList<>();
            fileReader = new FileReader(PATH + chooseClass.getSimpleName().toLowerCase() + FILE_EXTENTION);
            csvReader = new CSVReader(fileReader);
            CsvToBean<T> csvToBean = new CsvToBeanBuilder<T>(csvReader)
                    .withType(chooseClass)
